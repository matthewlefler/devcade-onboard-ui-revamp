...
public partial class OriginalGUI : Control, GuiInterface
{
	...
	/// <summary>
	/// returns a new instance of the texture with all pixels set to the monochrome space by averging the RGB values
	...
	private Texture2D makeMonochrome(Texture2D tex)
	{
		...
		// this is somewhat expensive as it gets the texture from the gpu, (I think)
		// so use it sparingly 
